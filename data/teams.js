const teamsData = [
  ...
  },
  {
    ...
    featured: false,
    stats: {
      overall: { position: 10, played: 82, wins: 46, losses: 36, points: 0 },
      home: { position: 8, played: 41, wins: 25, losses: 16, points: 0 },
      away: { position: 10, played: 41, wins: 21, losses: 20, points: 0 }
    },
    ...
    roster: [
      ...
      { name: "Jonathan Kuminga", position: "Forward", number: 22 },
  ...
  },
  {
    ...
    featured: false,
    stats: {
      overall: { position: 7, played: 82, wins: 47, losses: 35, points: 0 },
      home: { position: 6, played: 41, wins: 27, losses: 14, points: 0 },
      away: { position: 8, played: 41, wins: 20, losses: 21, points: 0 }
    },
  ...
  },
  {
    ...
    featured: true,
    stats: {
      overall: { position: 1, played: 70, wins: 48, losses: 22, points: 0 },
      home: { position: 1, played: 35, wins: 26, losses: 9, points: 0 },
      away: { position: 1, played: 35, wins: 22, losses: 13, points: 0 }
    },
  ...
  },
  {
    ...
    featured: true,
    stats: {
      overall: { position: 1, played: 35, wins: 25, losses: 8, draws: 2, points: 0 },
      home: { position: 1, played: 18, wins: 15, losses: 2, draws: 1, points: 0 },
      away: { position: 1, played: 17, wins: 10, losses: 6, draws: 1, points: 0 }
    },
  ...
  },
  {
    ...
    featured: false,
    stats: {
      overall: { position: 2, played: 70, wins: 42, losses: 28, points: 0 },
      home: { position: 2, played: 35, wins: 23, losses: 12, points: 0 },
      away: { position: 2, played: 35, wins: 19, losses: 16, points: 0 }
    },
  ...
  },
  {
    ...
    featured: false,
    stats: {
      overall: { position: 1, played: 20, wins: 13, losses: 7, points: 26 },
      home: { position: 1, played: 10, wins: 8, losses: 2, points: 16 },
      away: { position: 1, played: 10, wins: 5, losses: 5, points: 10 }
    },
  ...
  },
  {
    ...
    featured: false,
    stats: {
      overall: { position: 5, played: 20, wins: 9, losses: 11, points: 18 },
      home: { position: 4, played: 10, wins: 6, losses: 4, points: 12 },
      away: { position: 6, played: 10, wins: 3, losses: 7, points: 6 }
    },
  ...
  },
  {
    ...
    featured: true,
    stats: {
      overall: { position: 1, played: 38, wins: 28, losses: 3, draws: 7, points: 91 },
      home: { position: 1, played: 19, wins: 15, losses: 1, draws: 3, points: 48 },
      away: { position: 1, played: 19, wins: 13, losses: 2, draws: 4, points: 43 }
    },
    keyPlayers: ["Erling Haaland", "Kevin De Bruyne", "Phil Foden", "Rodri"],
    schedule: [
      { date: new Date("2024-11-15"), opponent: "Arsenal", location: "Away", time: "15:00" },
      { date: new Date("2024-11-22"), opponent: "Manchester United", location: "Home", time: "15:00" },
      { date: new Date("2024-11-29"), opponent: "Newcastle", location: "Away", time: "17:30" },
  ...
  },
  {
    ...
    featured: false,
    stats: {
      overall: { position: 2, played: 38, wins: 26, losses: 5, draws: 7, points: 85 },
      home: { position: 2, played: 19, wins: 14, losses: 2, draws: 3, points: 45 },
      away: { position: 2, played: 19, wins: 12, losses: 3, draws: 4, points: 40 }
    },
    ...
    roster: [
      ...
      { name: "Martin Ødegaard", position: "Midfielder", number: 8 },
      { name: "Gabriel Jesus", position: "Forward", number: 9 },
      { name: "Declan Rice", position: "Midfielder", number: 41 }
    ],
    isActive: true
  },
  {
    ...
    featured: false,
    stats: {
      overall: { position: 3, played: 38, wins: 24, losses: 4, draws: 10, points: 82 },
      home: { position: 3, played: 19, wins: 13, losses: 1, draws: 5, points: 44 },
      away: { position: 3, played: 19, wins: 11, losses: 3, draws: 5, points: 38 }
    },
    keyPlayers: ["Mohamed Salah", "Virgil van Dijk", "Alisson Becker", "Trent Alexander-Arnold"],
    schedule: [
      { date: new Date("2024-11-15"), opponent: "Manchester United", location: "Home", time: "16:00" },
      { date: new Date("2024-11-22"), opponent: "Tottenham", location: "Away", time: "15:00" },
      { date: new Date("2024-11-29"), opponent: "Arsenal", location: "Away", time: "16:00" },
  ...
  },
  {
    ...
    featured: true,
    stats: {
      overall: { position: 1, played: 32, wins: 25, losses: 2, draws: 5, points: 80 },
      home: { position: 1, played: 16, wins: 14, losses: 0, draws: 3, points: 45 },
      away: { position: 1, played: 16, wins: 11, losses: 2, draws: 2, points: 35 }
    },
    keyPlayers: ["Jude Bellingham", "Vinicius Junior", "Luka Modrić", "Thibaut Courtois"],
    schedule: [
      { date: new Date("2024-11-16"), opponent: "Barcelona", location: "Home", time: "20:00" },
      { date: new Date("2024-11-23"), opponent: "Atletico Madrid", location: "Away", time: "18:30" },
      { date: new Date("2024-11-30"), opponent: "Sevilla", location: "Home", time: "16:15" },
  ...
  },
  {
    ...
    featured: true,
    stats: {
      overall: { position: 1, played: 82, wins: 64, losses: 18, points: 0 },
      home: { position: 1, played: 41, wins: 37, losses: 4, points: 0 },
      away: { position: 1, played: 41, wins: 27, losses: 14, points: 0 }
    },
    keyPlayers: ["Jayson Tatum", "Jaylen Brown", "Kristaps Porzingis", "Derrick White"],
    schedule: [
      { date: new Date("2024-11-15"), opponent: "Detroit Pistons", location: "Away", time: "19:00" },
      { date: new Date("2024-11-18"), opponent: "Philadelphia 76ers", location: "Home", time: "19:30" },
      { date: new Date("2024-11-22"), opponent: "Milwaukee Bucks", location: "Away", time: "19:00" },
      { date: new Date("2024-11-26"), opponent: "Miami Heat", location: "Home", time: "19:30" }
    ],
    roster: [
      { name: "Jayson Tatum", position: "Small Forward", number: 0 },
      { name: "Jaylen Brown", position: "Shooting Guard", number: 7 },
      { name: "Kristaps Porzingis", position: "Center", number: 8 },
      { name: "Derrick White", position: "Point Guard", number: 9 },
      { name: "Jrue Holiday", position: "Point Guard", number: 4 },
      { name: "Al Horford", position: "Center", number: 42 },
      { name: "Robert Williams III", position: "Center", number: 44 },
      { name: "Malcolm Brogdon", position: "Point Guard", number: 13 },
      { name: "Grant Williams", position: "Power Forward", number: 12 },
      { name: "Payton Pritchard", position: "Point Guard", number: 11 }
    ],
    isActive: true
  },
  {
  ...
  },
  {
    ...
    roster: [
      ...
      { name: "Chris Paul", position: "Point Guard", number: 3 },
      { name: "Gary Payton II", position: "Shooting Guard", number: 0 },
      { name: "Jonathan Kuminga", position: "Forward", number: 12 },
      { name: "Moses Moody", position: "Shooting Guard", number: 4 },
      { name: "Dario Šarić", position: "Forward", number: 20 }
    ],
    isActive: true
  },
  {
    ...
    featured: true,
    stats: {
      overall: { position: 1, played: 70, wins: 45, losses: 25, points: 0 },
      home: { position: 1, played: 35, wins: 25, losses: 10, points: 0 },
      away: { position: 1, played: 35, wins: 20, losses: 15, points: 0 }
    },
    keyPlayers: ["Aaron Judge", "Gerrit Cole", "Giancarlo Stanton", "Anthony Rizzo"],
    schedule: [
      { date: new Date("2024-11-15"), opponent: "Boston Red Sox", location: "Home", time: "19:05" },
      { date: new Date("2024-11-18"), opponent: "Toronto Blue Jays", location: "Away", time: "19:07" },
      { date: new Date("2024-11-22"), opponent: "Tampa Bay Rays", location: "Home", time: "19:05" },
      { date: new Date("2024-11-26"), opponent: "Baltimore Orioles", location: "Away", time: "19:05" }
    ],
    roster: [
      { name: "Aaron Judge", position: "Right Field", number: 99 },
      { name: "Gerrit Cole", position: "Pitcher", number: 45 },
      { name: "Giancarlo Stanton", position: "Designated Hitter", number: 27 },
      { name: "Anthony Rizzo", position: "First Base", number: 48 },
      { name: "DJ LeMahieu", position: "Second Base", number: 26 },
      { name: "Gleyber Torres", position: "Second Base", number: 25 },
      { name: "Harrison Bader", position: "Center Field", number: 22 },
      { name: "Jose Trevino", position: "Catcher", number: 39 },
      { name: "Clay Holmes", position: "Pitcher", number: 35 },
      { name: "Carlos Rodón", position: "Pitcher", number: 55 }
    ],
    isActive: true
  },
  {
